...
/*
    public SceneBuilder(String sceneFileName) {
        ...
        String[] backgroundColor =
                _sceneDescriptor.getSceneAttributes().get("background-color").split("\\s+");
        ...
        int screenWidth =
                Integer.valueOf(_sceneDescriptor.getSceneAttributes().get("screen-width"));
        int screenHeight =
                Integer.valueOf(_sceneDescriptor.getSceneAttributes().get("screen-width"));
        _imageWriter = new ImageWriter("scene", screenWidth, screenHeight, screenWidth,screenHeight);
