...
public class TriangleTest {
    ...
    public void TriangleIntersectionPointsTest() {
        ...
        List<Point3D> intersectionPointsTriangle =
                new ArrayList<Point3D>();

        List<Point3D> intersectionPointsTriangle2 =
                new ArrayList<Point3D>();
        ...
        for (int i = 0; i < HEIGHT; i++) {
            for (int j = 0; j < WIDTH; j++) {
                ...
                for (
                        Point3D iPoint : rayIntersectionPoints)
                    intersectionPointsTriangle.add(iPoint);
                for (
                        Point3D iPoint : rayIntersectionPoints2)
